# Clipmart — Project Overview

> **One-Line Pitch:** The B2B marketplace for high-intent JaaS claim bundles, allowing law firms and claim aggregators to buy pre-vetted, audit-ready consumer claims.

| Field | Value |
|-------|-------|
| **Status** | ✅ Infrastructure Built |
| **Repo** | `e:\hermes\github_fleet\clipmart` |
| **Price** | 10% Escrow Split |
